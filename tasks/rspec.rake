...
namespace :spec do
  ...
  Spec::Rake::SpecTask.new(:plugins => spec_prereq) do |t|
    t.spec_opts = ['--options', "\"#{RAILS_ROOT}/spec/spec.opts\""]
    t.spec_files = FileList['vendor/plugins/**/spec/**/*_spec.rb'].exclude('vendor/plugins/rspec/*').exclude("vendor/plugins/rspec_on_hobo/*")
  end
  
  namespace :plugins do
    desc "Runs the examples for rspec_on_hobo"
    Spec::Rake::SpecTask.new(:rspec_on_hobo) do |t|
      t.spec_opts = ['--options', "\"#{RAILS_ROOT}/spec/spec.opts\""]
      t.spec_files = FileList['vendor/plugins/rspec_on_hobo/spec/**/*_spec.rb']
    end
  end
